namespace Example {
    ...
    public class ProjectTest {
        ...
        public void UserWantToCreateANewEventButSomeParametersAreWorng(string username, string name, string location, string country, string capacity, int code, string message) {
        ...
        [Test]
        public void UserWantToCreateANewEventButSomeParametersAreWorng() {
        ...
        [Test]
        public void UserWantToCreateANewEventButSomeParametersAreWorng() {
            UserWantToCreateANewEventButSomeParametersAreWorng("jhond", "", "Pusztamonostor", "Magyarorszag", "", 500, "Name of the event is must");
        }

        [Test]
        public void UserWantToCreateANewEventButSomeParametersAreWorng() {
            UserWantToCreateANewEventButSomeParametersAreWorng("alice", "oldtimer autok", "", "", "", 500, "Location of the event is must");
        }
        ...
        public void JhondUserPutAModificatedEventToTheEndpoint(string oldevent, string newevent, string oldlocation, string newlocation, string oldcountry, string newcountry, string oldcapacity, string newcapacity) {
        ...
        [Test]
        public void JhondUserPutAModificatedEventToTheEndpoint() {
            JhondUserPutAModificatedEventToTheEndpoint("koncert81", "koncert91", "Budapest", "Budapest", "", "", "", "");
        }

        [Test]
        public void JhondUserPutAModificatedEventToTheEndpoint() {
            JhondUserPutAModificatedEventToTheEndpoint("koncert82", "koncert82", "Budapest", "Pecs", "", "Magyarorszag", 100, "");
        }

        [Test]
        public void JhondUserPutAModificatedEventToTheEndpoint() {
            JhondUserPutAModificatedEventToTheEndpoint("koncert83", "koncert93", "Budapest", "Siofok", "Magyarorszag", "", "", 100);
        }


        public void UserWantToModifyTheEventButSomeParametersAreWorng(string username, string name, string location, string country, string capacity, int code, string message) {
        ...
        [Test]
        public void UserWantToModifyTheEventButSomeParametersAreWorng() {
        ...
        [Test]
        public void UserWantToModifyTheEventButSomeParametersAreWorng() {
            UserWantToModifyTheEventButSomeParametersAreWorng("jhond", "", "Pusztamonostor", "Magyarorszag", "", 500, "Name of the event is must");
        }

        [Test]
        public void UserWantToModifyTheEventButSomeParametersAreWorng() {
            UserWantToModifyTheEventButSomeParametersAreWorng("alice", "oldtimer autok", "", "", "", 500, "Location of the event is must");
        }
        ...
        [Test]
        public void JohndUserQueryAllEventsWithPaginator() {
        ...
        [Test]
        public void UnableToLogInWithWrongCredentials() {
